...
import com.lyae.workbook.b01.domain.QBoard;
import com.lyae.workbook.b01.domain.QReply;
import com.lyae.workbook.b01.dto.BoardImageDTO;
...
public class BoardSearchImpl extends QuerydslRepositorySupport implements BoardSearch {
    ...
    @Override public Page<Board> search1(Pageable pageable) {
...
//        query.where(board.title.contains("1")); // where title like ...
    ...
    @Override public Page<Board> searchAll(String[] types, String keyword, Pageable pageable) {
    ...
    @Override public Page<BoardListAllDTO> searchWithAll(String[] types, String keyword,
            Pageable pageable) {
        ...
        List<BoardListAllDTO> dtoList = tupleList.stream().map(tuple -> {
            ...
            //BoardImage를 BoardIamgeDTO 처리할 부분
